...
import com.kardex.HulkStore.HulkStore.Clases.ProductoParaVender;
import com.kardex.HulkStore.HulkStore.Entity.Producto;
import com.kardex.HulkStore.HulkStore.Entity.ProductoVendido;
import com.kardex.HulkStore.HulkStore.Entity.Venta;
import com.kardex.HulkStore.HulkStore.Repository.ProductosVendidosRepository;
import com.kardex.HulkStore.HulkStore.Repository.VentasRepository;
...
public class VenderController {
    ...
    public String terminarVenta(HttpServletRequest request, RedirectAttributes redirectAttrs) {
        ...
        for (ProductoParaVender productoParaVender : carrito) {
            ...
            Producto p = productoService.BuscarPorId(productoParaVender.getId()).orElse(null);
    ...
    public String agregarAlCarrito(@ModelAttribute Producto producto, HttpServletRequest request, RedirectAttributes redirectAttrs) {
        ArrayList<ProductoParaVender> carrito = this.obtenerCarrito(request);
        Producto productoBuscadoPorCodigo = productoService.BuscarPorCodigo(producto.getCodigo());
